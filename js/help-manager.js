jQuery(document).ready(function($){
  ...
  $('#verticalmenu_update_theme3').click(function(evn){
   ...
   if($('#verticalmenu_update_theme3').is(':checked'))
    { cval = '1';    }
   else
    { cval = '0';    }
   ...
   $('#verticalmenu-update-theme2').submit();

  });   
    
     $( "#verticalmenu-open-help" ).click(function() {
   ...
   $( "#verticalmenu-send-support" ).click(function(evt) {
       // cliccou no support
       
       // alert(evt.target.id);
       
       
       $modalvma = $('.bill-support-verticalmenu')
       var activated = $('#activated').val();
       
       if(activated !== '1')
       {
                        $("#verticalmenu-not-activated").dialog({
                            modal: true,
                            ...
                            buttons: {
                                Ok: function () {
                                    $(this).dialog("close");
                                    location.reload();
                                    /* $("#verticalmenu-not-activated").remove(); */
                                }
                            }
                        }); //end confirm dialog      
  ...
  $( ".button-close-spsubmit" ).click(function() {
       // submeteu support
                    // var isAnonymousFeedback = $(".anonymous").prop("checked");
                     ...
                     $('#verticalmenu-imagewait3').css('visibility','visible');
                     ...
                     $.ajax({
                		...
                		complete  : function () {
                             ...
                             // $modalvma = $('.bill-feedback-verticalmenu')
                              $('#verticalmenu-imagewait2').css('visibility','hidden');
                              $modalvma.slideUp();
   ...
   /*  Feedback ------ */
   $( "#verticalmenu-give-feedback" ).click(function(evt) {
       // cliccou no feedback
       
       $modalvmaf = $('.bill-feedback-verticalmenu');
  ...
  $( ".button-close-fbsubmit" ).click(function() {
       // submeteu feedback
                    ...
                    if(isAnonymousFeedback)
                    {
                     ...
                     $('#verticalmenu-imagewait2').css('visibility','visible');
  ...
  $("#verticalmenu-btn-connect-now" ).click(function(evt) {
                     ...
                     $('#verticalmenu-imagewait').css('visibility','visible');
                     $( "#verticalmenu-btn-connect-now" ).addClass('disabled');
                     $.ajax({
                	    url       : 'http://billminozzi.com/httpapi/httpapi.php',
                        withCredentials: true,
                        timeout: 15000,
                		...
                		complete  : function () {
                             ...
                             cvalue = "1-"+dom;
                             document.cookie = "bill_activated_vm" + "=" + cvalue + ";" + expires + ";path=/";
                             $('#verticalmenu-imagewait').css('visibility','hidden');
  ...
  $( ".button-close-faqsubmit" ).click(function() {
       // submeteu faq
                     ...
                     $('#verticalmenu-imagewait20').css('visibility','hidden');
                    ...
                    if(isAnonymousFeedback)
                    {
                     ...
                     $('#verticalmenu-imagewait20').css('visibility','visible');
