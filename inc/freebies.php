...
echo '<div id="verticalmenu-freebies-page">';

        
echo '<div class="verticalmenu-block-title">'; 
echo 'Freebies';
echo '</div>';
...
<div id="freebies-tab">
    ...
    <div class="freebies-row">
    <?php echo  '<img class="freebies-tab-icon" alt="aux" src="'.get_template_directory_uri().'/images/download-2.png"  />';?>
    <a class="freebies-tab-link" href="https://wordpress.org/plugins/boatdealer/">Boat Dealer Plugin</a>
    </div> 
    ...
    <div class="freebies-row"> 
    <?php echo  '<img class="freebies-tab-icon" alt="aux" src="'.get_template_directory_uri().'/images/download-2.png"  />';?>
    <a class="freebies-tab-link" href="https://wordpress.org/themes/boatdealer/">Boat Dealer Theme</a>
    </div> 
