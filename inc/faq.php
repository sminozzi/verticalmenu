 ...
 */
 ...
 if(! memory_status())
 {
    echo '<h3>Theme Vertical Menu Running in Save Memory Mode.</h3>';
    return;
  }   
      
?>
    <div id="verticalmenu-faq-page">
        <div class="verticalmenu-block-title"> 
               Faq Page
        </div>
    <div class="bill-faq-verticalmenu-wrap" style="">
     <div class="bill-faq-verticalmenu" style="">
     ...
     <br /><br />
     <textarea rows="6" id="explanationfaq" name="explanation" placeholder="<?php _e("type here your question ...","verticalmenu");?>" style="width:100%;" ></textarea>
                 <?php
                 if($activated != '1' )
                 {
  ?>
           ...
           <?php } ?>  
                 <br /><br /> 			
		    			<a href="#" class="button button-primary button-close-faqsubmit"><?php _e("Submit","verticalmenu");?></a>
                        <img alt="aux" src="/wp-admin/images/wpspin_light-2x.gif" id="verticalmenu-imagewait20" style="visibility:hidden" />
